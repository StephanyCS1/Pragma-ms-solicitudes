...
public abstract class RequestReactiveAdapterOperations<E, D, I, R extends ReactiveCrudRepository<D, I> & ReactiveQueryByExampleExecutor<D>> {
    ...
    protected RequestReactiveAdapterOperations(R repository, ObjectMapper mapper, Function<D, E> toEntityFn) {
